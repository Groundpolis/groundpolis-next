	...
	<FormSection>
		...
		<FormFolder v-if="!rememberNoteVisibility" class="_formBlock">
			...
			<FormSelect v-model="defaultNoteVisibility" class="_formBlock">
				...
				<option value="users">{{ i18n.ts._visibility.users }}</option>
			</FormSelect>
			<FormSwitch v-model="defaultNoteLocalOnly" class="_formBlock">{{ i18n.ts._visibility.localOnly }}</FormSwitch>
			<FormSwitch v-model="defaultNoteRemoteFollowersOnly" class="_formBlock">{{ i18n.ts._visibility.remoteFollowersOnly }}</FormSwitch>
		</FormFolder>
	</FormSection>

	<FormSection>
		<FormSwitch v-model="useDefaultNoteVisibilityOnRenote" class="_formBlock" @update:modelValue="save()">{{ i18n.ts._gp.useDefaultNoteVisibilityOnRenote }} <GpBadge /></FormSwitch>
		<FormFolder v-if="!useDefaultNoteVisibilityOnRenote" class="_formBlock">
			<template #label>{{ i18n.ts._gp.defaultRenoteVisibility }} <GpBadge /></template>
			...
			<FormSwitch v-model="defaultRenoteLocalOnly" class="_formBlock">{{ i18n.ts._visibility.localOnly }}</FormSwitch>
			<FormSwitch v-model="defaultRenoteRemoteFollowersOnly" class="_formBlock">{{ i18n.ts._visibility.remoteFollowersOnly }}</FormSwitch>
		</FormFolder>
	</FormSection>
